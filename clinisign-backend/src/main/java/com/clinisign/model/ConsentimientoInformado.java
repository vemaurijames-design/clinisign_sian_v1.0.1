...
public class ConsentimientoInformado {
    ...
    @Column(length = 20)
    @Builder.Default
    private String codigo = "HC-FM-04";
    ...
    @Column(name = "numero_identidad", length = 30)
    private String numeroIdentidad;

    @Column(length = 20)
    @Builder.Default
    private String calidad = "PACIENTE";

    @Column(name = "responsable_de", length = 100)
    ...
    @Column(name = "proc_otro", length = 200) private String procOtro;
